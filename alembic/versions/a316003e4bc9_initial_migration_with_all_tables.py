...
def upgrade() -> None:
    ...
    sa.Column('name', models.reference.CaseInsensitiveText(length=100), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', models.reference.CaseInsensitiveText(length=200), nullable=False),
    ...
    op.create_index(op.f('ix_cards_scryfall_oracle_id'), 'cards', ['scryfall_oracle_id'], unique=True)
    ...
    sa.Column('normalized_handle', models.reference.CaseInsensitiveText(length=100), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_player_normalized_handle', 'players', ['normalized_handle'], unique=False)
    op.create_index(op.f('ix_players_normalized_handle'), 'players', ['normalized_handle'], unique=False)
    ...
    op.create_index('idx_meta_change_format_date', 'meta_changes', ['format_id', 'date'], unique=False)
    op.create_index(op.f('ix_meta_changes_date'), 'meta_changes', ['date'], unique=False)
    op.create_index(op.f('ix_meta_changes_format_id'), 'meta_changes', ['format_id'], unique=False)
    ...
    op.create_index('idx_tournament_date_format', 'tournaments', ['date', 'format_id'], unique=False)
    op.create_index(op.f('ix_tournaments_date'), 'tournaments', ['date'], unique=False)
    op.create_index(op.f('ix_tournaments_format_id'), 'tournaments', ['format_id'], unique=False)
    ...
    op.create_index('idx_entry_archetype', 'tournament_entries', ['archetype_id'], unique=False)
    op.create_index('idx_entry_tournament_player', 'tournament_entries', ['tournament_id', 'player_id'], unique=False)
    op.create_index(op.f('ix_tournament_entries_archetype_id'), 'tournament_entries', ['archetype_id'], unique=False)
    op.create_index(op.f('ix_tournament_entries_player_id'), 'tournament_entries', ['player_id'], unique=False)
    ...
    op.create_index('idx_deck_card_entry_board', 'deck_cards', ['entry_id', 'board'], unique=False)
    op.create_index(op.f('ix_deck_cards_card_id'), 'deck_cards', ['card_id'], unique=False)
    op.create_index(op.f('ix_deck_cards_entry_id'), 'deck_cards', ['entry_id'], unique=False)
    ...
    op.create_index('idx_match_entry_opponent', 'matches', ['entry_id', 'opponent_entry_id'], unique=False)
    ...
    op.create_index(op.f('ix_matches_opponent_entry_id'), 'matches', ['opponent_entry_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_tournament_entries_player_id'), table_name='tournament_entries')
    op.drop_index(op.f('ix_tournament_entries_archetype_id'), table_name='tournament_entries')
