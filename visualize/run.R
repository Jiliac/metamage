...
ensure_packages(c(
  "DBI","RSQLite","glue","dplyr","tidyr","stringr","lubridate",
  "ggplot2","scales","ggrepel","forcats","tibble","patchwork"
))
...
wr_pres <- wr %>%
  ...
  select(archetype_name, wins, losses, draws, games, wr, wr_lo, wr_hi, entries, share)
